...
#include "stockDataHeader.h"  // Include your StockData class header
...
int main() {
    try {
        std::string stockSymbol = "AMD"; // Example stock symbol
        ...
        std::string filepath = "fetched_stock_data.csv";
        ...
        stock.calculateEMA(14);  // Example period for EMA
        std::cout << "Calculated EMA.\n";

        stock.calculateRSI(14);  // Example period for RSI
        ...
        std::cout << "Data processed and visualized successfully.\n";
